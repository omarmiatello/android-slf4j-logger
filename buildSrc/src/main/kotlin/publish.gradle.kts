        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    scm {
                        connection.set("scm:git:git://github.com/omarmiatello/android-slf4j-logger.git")
                        developerConnection.set("scm:git:ssh://github.com/omarmiatello/android-slf4j-logger.git")
                        url.set("https://github.com/omarmiatello/android-slf4j-logger/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/omarmiatello/android-slf4j-logger/issues")
                    }
                }
            }
        }
